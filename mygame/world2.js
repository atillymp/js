class world2 extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("city2", "assets/city2.tmj");
    ...
    this.load.image("defimonImg", "assets/defimon1.png");
     ...
     this.load.spritesheet('bottleImg', 'assets/col1-anim.png', { frameWidth:32, frameHeight:32 });
  ...
  create() {
    ...
    this.anims.create({
        key:'bottleAnim',
        frames:this.anims.generateFrameNumbers('bottleImg',
        { start:0, end:4 }),
        frameRate:10,
        repeat:-1
    });

     this.bottle = this.add.sprite(100, 100, 'bottleImg').play('bottleAnim')
